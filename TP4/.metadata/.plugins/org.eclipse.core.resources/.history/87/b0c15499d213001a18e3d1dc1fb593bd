...
int main()
{
	saaq::Camion unCamion1(3000, 3, "3VWFE21C04M000002", "L123123");
	saaq::Camion unCamion2(3001, 3, "3VWFE21C04M000001", "L123123");
	saaq::VehiculePromenade unVehiculeprome(4, "3VWFE21C04M000003", "123 ASD");
	saaq::Proprietaire unProprio1("Tremblay", "Louis");
	unProprio1.ajouterVehicule(unCamion1);
	unProprio1.ajouterVehicule(unCamion2);
	unProprio1.ajouterVehicule(unVehiculeprome);
	cout << unProprio1.reqProprietaireFormate();
	unProprio1.supprimerVehicule("3VWFE21C04M000001");
	cout << unProprio1.reqProprietaireFormate();
